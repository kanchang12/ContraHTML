...
const LESSONS: Lesson[] = [
  {
    ...
    title: "My Bio Page",
    description:
      "Create your own bio page with a heading, photo, and about text",
  ...
  },
  {
    ...
    title: "Blog Post",
    description:
      "Learn text formatting by creating a blog post with bold and italic text",
    initialCode:
    ...
    steps: [
      {
        ...
        validation: (code) => code.includes("My First Blog Post"),
      },
      {
        instruction: "Add your name 'Sam' in the <strong> tag (after 'By ')",
        hint: "Type between the first <strong> and </strong>",
        validation: (code) => code.match(/<strong>Sam<\/strong>.*on Monday/),
      },
      {
        instruction: "Add 'HTML' inside the <em> tag to make it italic",
        hint: "Type between <em> and </em>",
        validation: (code) => code.includes("<em>HTML</em>"),
      },
      {
        instruction: "Add 'Tags' in the last <strong> tag to make it bold",
        hint: "Type between the second <strong> and </strong>",
        validation: (code) => code.includes("<strong>Tags</strong>"),
      },
    ],
  },
  {
    ...
    title: "Shopping List",
    description:
      "Learn about lists by creating a shopping list with priorities",
    initialCode:
    ...
    steps: [
      {
        ...
        validation: (code) => code.includes("Milk"),
      },
      {
        instruction: "Add 'Bread' to the second important item",
        hint: "Type in the second <li> under Important Items",
        validation: (code) => code.includes("Bread"),
      },
      {
        instruction:
          "Add 'Apples' to the first regular item in the ordered list",
        hint: "Type in the first <li> under Regular Items",
        validation: (code) => code.includes("Apples"),
      },
      {
        instruction: "Add 'Cheese' to the second regular item",
        hint: "Type in the second <li> under Regular Items",
        validation: (code) => code.includes("Cheese"),
      },
    ],
  },
  {
    ...
    title: "Contact Form",
    description:
      "Learn about forms by creating a contact form with input fields",
    initialCode:
    ...
    steps: [
      {
        ...
        validation: (code) => code.includes('placeholder="Your name"'),
      },
      {
        instruction:
      ...
      },
      {
        ...
        validation: (code) => code.includes('placeholder="Write your message"'),
      },
      {
        instruction: "Add button text 'Send' inside the <button> tag",
        hint: "Type between <button> and </button>",
        validation: (code) => code.includes("<button>Send</button>"),
      },
    ],
  },
  {
    ...
    title: "Photo Gallery",
    description:
      "Learn layout by creating a photo gallery with multiple images",
    initialCode:
    ...
    steps: [
      {
        ...
        validation: (code) => {
          const matches = code.match(
            /src="https:\/\/via\.placeholder\.com\/100"/g,
          );
          return matches && matches.length >= 1;
        },
      },
      {
        instruction: "Add the same image URL to the second photo",
      ...
      {
        instruction: "Add the same image URL to the third photo",
    ...
    steps: [
      {
        ...
        validation: (code) => code.includes("Flour"),
      },
      {
        instruction: "Add '2 cups' as the amount for Flour",
        hint: "Type in the second <td> of the first row",
        validation: (code) => code.includes("2 cups"),
      },
      {
        instruction: "Add 'Cheese' as the second ingredient",
        hint: "Type in the first <td> of the second row",
        validation: (code) => code.includes("Cheese"),
      },
      {
        instruction: "Add '1 cup' as the amount for Cheese",
        hint: "Type in the second <td> of the second row",
        validation: (code) => code.includes("1 cup"),
      },
      {
        instruction: "Add 'Tomato Sauce' as the third ingredient",
        hint: "Type in the first <td> of the third row",
        validation: (code) => code.includes("Tomato Sauce"),
      },
      {
        instruction: "Add '1 cup' as the amount for Tomato Sauce",
